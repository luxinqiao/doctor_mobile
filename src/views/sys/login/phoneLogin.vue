...
<script lang="ts">
    ...
    export default class phoneLoginIndex extends Vue {
        ...
        */
        login() {
            ...
            if (!isEmpty(sessionStorage.md_wechat_unionid) && !isEmpty(sessionStorage.md_wechat_nickname) && !isEmpty(sessionStorage.md_wechat_headimgurl)) {
                ...
                this.$axios.post(`${this.$request.rih}/API/V1/DoctorLoginForToken/doctorValidIdenfifyCodeByTelForLogin`, {
                    login_type: 0,
        ...
        */
        goUserAgree() {
            window.location.href = `${this.$request.web}/#/agent/doctor`
        }
...
<style lang='scss' scoped>
    #main {
        ...
        >.con {
            ...
            >.btn_unuse {
                background-color: rgba(38, 194, 196, 0.3);
            }
        }
        >.desc {
            position: fixed;
