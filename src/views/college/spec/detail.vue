...
<div id='main' :class='data.is_authed=="0"?(isIphoneX?"hasBtnIphoneX":"hasBtn"):""' :style='"padding-top:"+headHeight+"px"'>
    ...
    <md-custom :show.sync='customShow' id='load' type='transparent'>
        <img :src='require("@/assets/img/college/course/detail/load.gif")'>
    </md-custom>
    ...
    <div id='appJump' v-if='browserType=="app"&&func.getAppProduct()=="wrightin"' :style='"top:"+headHeight+"px"' @click='jumpWrightin()'>
        <div :class='["appJump-btn" ,isIphoneX?"iphoneX_btn":""]'>
            <div class='appJump-btn-text'>打开澜渟医生App学习</div>
        </div>
    </div>
</div>
</template>
...
<script lang='ts'>
    ...
    export default class collegeSpecDetail extends Vue {
        ...
        buy() {
            checkToken(()=>{
                let url: string = `${this.$request.pay}/#/doctor/college/product`
        ...
        playCatalog(item: any, i: number) {
            ...
            if (item.source_type == '1') { //直播
                this.$router.push(`../live/detail?live_code=${item.code}&type=${item.is_broad == "1" ? "LTD13" : "LTD11"}`)
            } else { //课程
                this.playVideo(item.code)
            }
        }
    ...
    #main {
        ...
        #download {
            ...
            >.msg {
                ...
                >p:nth-child(1) {
                    line-height: 1.6rem;
                    font-size: 1.5rem; color: #26C2C4;
                }
                >p:nth-child(2) {
                    margin-top: 0.5rem;
                    line-height: 1.3rem;
                    font-size: 1.3rem; color: #7DB5B4;
                }
            }
            .download-box {
                position: absolute;
        ...
        #banner {
            ...
            .banner-shade.tryEnd {
                ...
                >.buy {
                    ...
                    border-radius: 3rem;
                    font-size: 1.3rem;
                    background-color: #26C2C4; color: #e3e3e3;
                }
            }
        ...
        #btn {
            ...
            >.btn-try {
                ...
                >.arrow {
                    ...
                    margin: auto;
                    width: 0; height: 0;
                    border-top: 0.53rem solid transparent; border-bottom: 0.53rem solid transparent; border-left: 0.7rem solid #26C2C4;
                }
                >.split {
                    position: absolute;
                    top: 0; bottom: 0; right: 1.2rem;
        ...
        #couponPopup {
            ...
            >.couponPopup-confirm {
                ...
                >.btn {
                    ...
                    font-size: 1.6rem;
                    background-color: #26C2C4; color: #FFF;
                }
            }
        }
        #offShelf {
