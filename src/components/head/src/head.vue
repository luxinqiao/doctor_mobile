...
export default class mdHead extends Vue {
    //返回按钮图标：none-无, backWhite-白色返回, backBlack-黑色返回, closeBlack-黑色关闭, backBlue-蓝色返回, require图片-自定义传入
    ...
    //背景色：white-白色, green-#26C2C4, transparent-透明
    ...
    mounted() {
        ...
        } else if (this.backIcon == 'backBlue') {
            this.backImg = require('../img/back_blue.png')
        } else {
