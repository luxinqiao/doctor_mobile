    ...
    */
    initAPPDom() {
        ...
        btn.addEventListener('error', (e:any)=> {
            ...
            openAppNormal('doctor',this.openAppNormalUrl)
        })
    }

    /** 
     * 初始化打开app的链接，即lanting://或者lantingdoctor://后携带的路径参数
     * LTD09-视频课程 LTD10-专栏  LTD11-音频直播 LTD12-音频课程  LTD13-视频直播
    */
    initUrl() {
        if (!this.extinfo) {
            return
        }
        if (this.extinfo.type == 'LTD09' || this.extinfo.type == 'LTD10' || this.extinfo.type == 'LTD11' || this.extinfo.type == 'LTD12' || this.extinfo.type == 'LTD13') {
